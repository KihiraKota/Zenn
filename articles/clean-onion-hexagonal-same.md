...
さて、ここまででの話で、ヘキサゴナル、オニオン、クリーン、という3つのアーキテクチャは、すべて同じものだということにご納得いただけたでしょうか？

唯一これらに違いがあるといえば、ドメイン層の中のレイヤーの分け方くらいのものですが、ドメイン層の中を分けていないヘキサゴナルでも、オニオンのApplication Servicesや、クリーンのApplication Business RulesにあるUse Casesに相当するクラスは作ります。結局のところ、図に描いてあるのかないのかの違いで、どのアーキテクチャを採用しても本質的には同じようなコードを書くのです。
...
それにしても、3つのアーキテクチャはそれぞれ別の人が別のタイミングで考えたものなのに、何で結局同じになっちゃうんだろう？と思った人に向けてのネタばらし
